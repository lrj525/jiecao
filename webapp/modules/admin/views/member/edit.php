...
<div class="row member-edit" ng-controller="memberCtrl" ng-init="initEdit()">
    <div class="col-xs-12">
        <form class="form-horizontal" name="submit_form">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="text" class="form-control" placeholder="姓名" ng-model="dataModel.name" name="name1"  errormsg="姓名必须填写" />
                </div>
            </div>
            <div class="form-group">
