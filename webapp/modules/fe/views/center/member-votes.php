...
<div class="vote ngCloak" ng-controller="memberVotesCtrl" ng-init="getList(1)">
        ...
        <div class="col-xs-8 title">
            <table>
                <tr>
                    ...
                    <td>
                        &nbsp;
                        <button href="" class="btn btn-success " ng-click="getList()">确定</button>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="row list" ng-repeat="item in list">
        <div class="col-xs-3">
            ...
            <p class="time">
                <a class="time" ng-href="/fe/center/member-votes?id={{item.supporter_member_id}}">{{item.supporter_name}}</a>
                <br />@
